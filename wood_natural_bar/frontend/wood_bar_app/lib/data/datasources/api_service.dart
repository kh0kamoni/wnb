...
class ApiService {
  ...
  Future<MenuItemModel> getMenuItem(int id) async {
    final res = await _dio.get('$apiUrl/menu/items/$id');
    return MenuItemModel.fromJson(res.data);
  }

  Future<void> createCategory(Map<String, dynamic> data) async {
    await _dio.post('$apiUrl/menu/categories', data: data);
  }
  ...
  Future<void> changePassword(int userId, Map<String, dynamic> data) async {
    await _dio.post('$apiUrl/users/$userId/change-password', data: data);
  }
  ...
  Future<dynamic> updateReservation(int id, Map<String, dynamic> data) async {
    final res = await _dio.patch('$apiUrl/reservations/$id', data: data);
    return res.data;
  }
